...
public class Skills_Adapter extends BaseExpandableListAdapter {
    private Context ctx;
   ...
   private int arg0;
    ...
    public Skills_Adapter(Context ctx1,HashMap<String,List<String>> Skills_Category1,List<String> Skills_List1 )
    {
        ctx=ctx1;
